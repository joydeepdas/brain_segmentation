...
#     '''
#     progress.currval = 0
#     slices = io.imread(labels[15], plugin = 'simpleitk')
#     io.imsave('Labels/{}_{}L.png'.format(15, 1), slices[1])


if __name__ == '__main__':
   # labels = glob('../BRATS2015_Training/BRATS2015_Training/HGG/**/*more*/**.mha')
   # save_labels(labels)
   patients = glob('../BRATS2015_Training/BRATS2015_Training/HGG/**')
